...
open class HomeViewController: UIViewController {
    ...
    let firstWordList = ["1-1", "1-2", "1-3", "1-4", "1-5"]
    ...
    open func getRandomNumberFirst() {
        ...
        firstWordLabel.text = firstWordList[randomNoFirst]
    ...
    open func getRandomNumberSecond() {
        ...
        secondWordLabel.text = secondWordList[randomNoSecond]
    ...
    open func getRandomNumberThird() {
        ...
        thirdWordLabel.text = thirdWordList[randomNoThird]
